...
class Notification(models.Model):
    ...
    def format(self, record):
        ...
        if model == Like:
            ...
            extra = (
                f"{record.message} + media attachment"
                if record.media_item
            ...
            extra = (
                f"{record.request.message} + media attachment"
                if record.request.media_item
    ...
    def notify(self, receiver, record):
            ...
            if receiver.connected:
                ...
                async_to_sync(get_channel_layer().group_send)(
                    f"notification_{receiver.public_id}",
                    {
                        ...
                        "content": {"type": "site_notification", "data": data},
                    },
                )
        ...
        if (
            receiver.site_message
            and record._meta.model
            and not record._meta.model == ChatMessage
        ):
